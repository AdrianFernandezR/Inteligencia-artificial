...
class Tablero {
  ...
  Tablero(int dimension, int tamCasilla) {
    ...
    descripcionDificultad[2] = "Experto";
    dificultad = 0;
  ...
  void display() {
    ...
    text(mensaje,dimension*tamCasilla + 10, 400);
    text(mensaje2,dimension*tamCasilla + 10, 440);
    ...
    fill(textoColor); // establecer color de texto
    text(descripcionDificultad[2], dimension*tamCasilla + tamCasilla + 10, 315);
